...
price_data = load_prices('data/crvusdt-1m.json.gz', add_reverse=False)
...
if __name__ == '__main__':
    ...
    print(get_loss_rate(0.01, 0.006, measure='xtopmax2', min_loan_duration=0.3, max_loan_duration=0.3, Texp=600,
